...
#path to use for figures if forcing the png driver (to reduce file size)
figpath="manuscript/appendices/figure/"
figp=function(x) paste(figpath,x,sep="")
...
This appendix includes detailed description of the compositing procedure. The VSNR was well suited to this situation because it allows specification of the structure of the 'noise'.  This section details the effects of the correction procedure in several regions.  
