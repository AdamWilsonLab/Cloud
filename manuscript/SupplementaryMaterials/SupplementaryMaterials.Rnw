...
GEWEX/ICCP & Compiled from 12 satellite products for comparison study & Global          & 1$^o$ ($/sim$110km) & 1983-2009   & Monthly & \citep{Stubenrauch_assessment_2013} \\
                                                       &                                                                                                    &                &                    &                 &                     &                           \\
                                                       &                                                                                                    &                &                    &                 &                     &                          
\end{tabular}
\end{table}
...
dt=raster("data/out/SaharaBiasCorrectionExample.tif")
